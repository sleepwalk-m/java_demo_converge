package com.mask.aliyun.server;
...
import com.mask.aliyun.util.ClientUploader;
...
public class ImgScan {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try{
            url = clientUploader.uploadFile("E:\\Heima\\verysync_project\\黑马头条\\黑马头条资料\\day06\\资料\\图片\\ak47.jpg");
        }catch (Exception e){
            e.printStackTrace();
        }
